...
- **补齐正式 Dock 图标**：采用蓝色分屏 Logo，修复原来在 Dock 中显示为空白的问题。
...
本项目完整源码公开。只想马上使用的话，直接前往 [Releases](../../releases) 下载最新版 `AkangMacTieTie-v1.0.2-macos.zip`，解压后将“阿康的 Mac 贴贴.app”拖入“应用程序”即可。
...
构建产物位于 `release/AkangMacTieTie-v1.0.2-macos.zip`。发布脚本会生成 Apple 芯片与 Intel Mac 都能运行的通用包。
